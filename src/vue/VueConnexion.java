...
public class VueConnexion extends JFrame implements ActionListener, KeyListener
{
	...
	public  VueConnexion() {
		...
		//placement du logo 
		ImageIcon uneImage = new ImageIcon ("src/images/logo.jpeg"); 
		JLabel unLogo = new JLabel(uneImage);
		unLogo.setBounds(30, 20, 240, 220);
		this.add(unLogo);
		//placement du pannel 
		this.panelConnexion.setBounds(300, 40, 250, 200);
		this.panelConnexion.setBackground(new Color (225, 198, 22));
	...
	public void traitement () {
		String email = this.txtEmail.getText(); 
		 ...
		 if (unUser != null) {
			 ...
			 IRISEVENT.rendreVisibleGenerale(true, unUser);
			 IRISEVENT.rendreVisibleConnexion(false);
		 }else {
